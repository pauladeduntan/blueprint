...
- Do not store consent forms, contact details, raw recordings, raw transcripts, or screenshots of personal messages or apps in this public repository.
...
- An evaluation instrument: do not record numeric ratings, scales, or scores (for example, 1 to 5 “pressure” scales).

## Terminology

- Use `materials_captured` to record topics, prompts, or scenarios covered (for example, “Save Progress framing”, “boundary integrity vignette”, “High-Stakes Handoff Item scenario”).
- Avoid `outcome_measures` language to prevent performance framing.
