...
Implementation mechanics are intentionally not included in this public repository (for example, schema/RLS/RPC specifics, operational scripts, and build instructions). This is a non-commercial research record, not a delivery tracker.

## Core Files

- `domain-language.md`
- `invariants.md`
- `product-definition.md` (Artefact Definition)
- `system-flows.md`
- `appendix/`
