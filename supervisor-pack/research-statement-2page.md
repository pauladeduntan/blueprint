...
- Visibility Without Enforcement: Activity treated as a readable record of shared intent, not a performance feed and not a notification centre, with anti-amplification constraints (no per-person views, counts, sorting, grouping, filtering, or similar performance-like interpretation).
...
My empirical strategy combines:
